...
async function retrieveEvents(CONCURRENCY_LIMIT, success) {
  ...
  try {
    ...
    for (let i = 0; i < conc_limit; i++) {
      ...
      const initialLink = endpoint + '?api_key=joKObkCY2YiDI1x0ENw18Rptd3Scr2Lh0dICGXF0&search=date_started:[' + chunkStart + '+TO+' + chunkEnd + ']&sort=date_started:asc&limit=100';
